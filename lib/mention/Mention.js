...
var Mention = (function (_React$Component) {
  ...
  _createClass(Mention, [{
    ...
    key: 'propTypes',
    value: {
      dataSource: _propTypes2['default'].oneOfType([_propTypes2['default'].array, _propTypes2['default'].func, _propTypes2['default'].object]),
      asyncDataSource: _propTypes2['default'].func,
      beforeAdd: _propTypes2['default'].func,
      customListRenderer: _propTypes2['default'].func,
      customRTEMention: _propTypes2['default'].func,
      delimiter: _propTypes2['default'].string,
      onAdd: _propTypes2['default'].func,
      onRemove: _propTypes2['default'].func,
      showDebugger: _propTypes2['default'].bool,
      transformFn: _propTypes2['default'].func
    },
    enumerable: true
  }, {
    key: 'defaultProps',
