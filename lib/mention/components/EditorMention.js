...
var EditorMention = (function (_React$Component) {
  _inherits(EditorMention, _React$Component);

  function EditorMention() {
    _classCallCheck(this, EditorMention);

    _get(Object.getPrototypeOf(EditorMention.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(EditorMention, [{
    ...
    key: 'propTypes',
    value: {
      tinymceId: _propTypes2['default'].string.isRequired,
