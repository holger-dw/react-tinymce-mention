...
var TinyMCEDelegate = (function (_Component) {
  ...
  function TinyMCEDelegate() {
    _classCallCheck(this, TinyMCEDelegate);

    _get(Object.getPrototypeOf(TinyMCEDelegate.prototype), 'constructor', this).apply(this, arguments);
  ...
  _createClass(TinyMCEDelegate, [{
    ...
    value: function componentDidUpdate() {
      ...
      if (editor && mentionsValid && shouldRender) {
        if (beforeAdd) {
          beforeAdd(this._renderMentionIntoEditor.bind(this), (0, _utilsLast2['default'])(mentions));
        } else {
    ...
    value: function _renderMentionIntoEditor() {
      ...
      var re = new RegExp(delimiter + '\\S+___PLACEHOLDER___');
    ...
    key: 'propTypes',
    value: {
      beforeAdd: _propTypes2['default'].func,
      customRTEMention: _propTypes2['default'].func,
...
exports.TinyMCEDelegate = TinyMCEDelegate;
